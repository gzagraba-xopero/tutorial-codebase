...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    //EXAMPLE OF REDIRECTING ROUTE
    $routes->redirect('/generate1','http://tutorialspoint.com/');

    //EXAMPLE OF USING SET ACTION
